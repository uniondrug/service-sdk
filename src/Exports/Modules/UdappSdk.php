...
class UdappSdk extends SdkBase
{
    ...
    /**
     * 机器配置详情
     * @link https://uniondrug.coding.net/p/module.udapp/git/blob/development/docs/api/BlueController/detailAction.md
     * @param array|object $body  入参类型
     * @param null         $query Query数据
     * @param null         $extra 请求头信息
     * @return ResponseInterface
    ...
    /**
     * 创建
     * @link https://uniondrug.coding.net/p/module.udapp/git/blob/development/docs/api/Assistant/WithdrawRecordController/createAction.md
     * @param array|object $body  入参类型
     * @param null         $query Query数据
     * @param null         $extra 请求头信息
     * @return ResponseInterface
     */
    public function withdrawRecordCreate($body, $query = null, $extra = null)
    {
        return $this->restful("POST", "/withdraw/record/create", $body, $query, $extra);
    }

    /**
     * 创建
     * @link https://uniondrug.coding.net/p/module.udapp/git/blob/development/docs/api/Assistant/WithdrawRecordController/detailAction.md
     * @param array|object $body  入参类型
     * @param null         $query Query数据
     * @param null         $extra 请求头信息
     * @return ResponseInterface
     */
    public function withdrawRecordDetail($body, $query = null, $extra = null)
    {
