...
class UdappSdk extends SdkBase
{
    ...
    /**
     * 根据类型查询
     * @link https://uniondrug.coding.net/p/module.udapp/git/blob/development/docs/api/ConfigController/getByConfigTypeAction.md
     * @param array|object $body  入参类型
     * @param null         $query Query数据
     * @param null         $extra 请求头信息
     * @return ResponseInterface
     */
    public function getByConfigType($body, $query = null, $extra = null)
    {
        return $this->restful("POST", "/config/getByConfigType", $body, $query, $extra);
    }
}
