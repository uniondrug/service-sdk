 ...
 * @date   2021-05-08
 * @time   Sat, 08 May 2021 11:19:58 +0800
 */
...
class PsModuleUdcsSdk extends SdkBase
{
    ...
    /**
     * 详情
     * @link https://uniondrug.coding.net/p/ps-module-udcs/git/blob/development/docs/api/CrowdsourcingBatchController/detailAction.md
     * @param array|object $body 入参类型
     * @param null $query  Query数据
     * @param null $extra  请求头信息
     * @return ResponseInterface
     */
    public function detailCrowdsourcingBatch($body, $query = null, $extra = null)
    {
        return $this->restful("POST", "/crowdsourcingBatch/detail", $body, $query, $extra);
    }
