...
class PsDpspTcSdk extends SdkBase
{
    ...
    /**
     * 项目
     * @link https://uniondrug.coding.net/p/order.tc.dpsp.ps/git/blob/development/docs/api/Gift/GiftController/projectAction.md
     * @param array|object $body 入参类型
     * @param null $query  Query数据
     * @param null $extra  请求头信息
     * @return ResponseInterface
     */
    public function giftProject($body, $query = null, $extra = null)
    {
        return $this->restful("POST", "/gift/project", $body, $query, $extra);
    }
