 ...
 * @date   2021-03-22
 * @time   Mon, 22 Mar 2021 18:45:32 +0800
 */
...
class PsDstoreCustomerSdk extends SdkBase
{
    ...
    /**
     * 列表
     * @link https://uniondrug.coding.net/p/ps-dstore-cart/ps-dstore-cart/docs/api/MessageController/initActAction.md
     * @param array|object $body 入参类型
     * @param null $query  Query数据
     * @param null $extra  请求头信息
     * @return ResponseInterface
     */
    public function messageInitAct($body, $query = null, $extra = null)
    {
        return $this->restful("POST", "/message/initAct", $body, $query, $extra);
    }
